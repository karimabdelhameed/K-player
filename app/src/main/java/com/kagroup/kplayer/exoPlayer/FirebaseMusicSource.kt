...
import com.kagroup.kplayer.data.remote.MusicDatabase
...
class FirebaseMusicSource @Inject constructor(private val musicDatabase: MusicDatabase) {
    ...
    suspend fun fetchMediaData() = withContext(Dispatchers.IO) {
        ...
        songs = allSongs.map { song ->
            MediaMetadataCompat.Builder()
                .putString(METADATA_KEY_ARTIST, song.sub_title)
                ...
                .putString(METADATA_KEY_DISPLAY_SUBTITLE, song.sub_title)
                .putString(METADATA_KEY_DISPLAY_DESCRIPTION, song.sub_title)
                .build()
        }
    ...
    private val onReadyListeners = mutableSetOf<(Boolean) -> Unit>()
